...
#define MENUITEM_OPTION_1_YPOS (PIXEL_TO_CHAR_HEIGHT*MENUFRAME_YPOS + CHAR_PADDING_Y)
#define MENUITEM_OPTION_2_YPOS (MENUITEM_OPTION_1_YPOS + CHAR_NEWLINE)

#define MENU_SELECTOR_PADDING 3
#define MENU_SELECTOR_XPOS (MENUITEM_START_XPOS*(CHAR_TO_PIXEL_WIDTH) - MENU_SELECTOR_PADDING)
#define MENU_SELECTOR_OPTION_1_YPOS (MENUITEM_OPTION_1_YPOS*(CHAR_TO_PIXEL_HEIGHT) - MENU_SELECTOR_PADDING)
#define	MENU_SELECTOR_OPTION_2_YPOS (MENU_SELECTOR_OPTION_1_YPOS + CHAR_TO_PIXEL_HEIGHT*CHAR_NEWLINE)
...
#define INSTRUCTIONITEM_TITLE_YPOS (MENUITEM_OPTION_2_YPOS-CHAR_TO_PIXEL_HEIGHT*7)
...
#define SCOREBAR_ADD_HINT_XPOS (SCOREBAR_LEVEL_VAL_XPOS + SCOREBAR_SPACING + SCOREBAR_VAL_WIDTH)
#define SCOREBAR_MUL_HINT_XPOS (SCOREBAR_ADD_HINT_XPOS + 16)

#define SCOREBAR_CURRENT_STRING "Current:"
#define SCOREBAR_TARGET_STRING "Target:"
#define SCOREBAR_LEVEL_STRING "Level:"

#define SCOREBAR_ADD_HINT_STRING "Keys: [1]+ [2]- "
#define SCOREBAR_MUL_HINT_STRING "[3]* [4]/"
